...
def targets():
    ...
    return [
        ...
        PythonArtifact('manylinux2014', 'arm64', 'cp35-cp35m'),
        PythonArtifact('manylinux2014', 'arm64', 'cp36-cp36m'),
        PythonArtifact('manylinux2014', 'arm64', 'cp37-cp37m'),
        PythonArtifact('manylinux2014', 'arm64', 'cp38-cp38m'),
        PythonArtifact('manylinux2014', 'arm64', 'cp39-cp39m'),
